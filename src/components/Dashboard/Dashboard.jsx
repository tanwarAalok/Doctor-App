...
import { AllAmbulance, AllDoctors, AllPatients, AllPharmas } from "../Axios/apis";
        ...
        <div className="main-div">
          ...
          <div className="card-container">
            <Link to="/patients" className="dashboardCards">
              ...
              <h4>{patients === null ? 0 : patients.length}</h4>
              <p>Total Patients</p>
            </Link>
            ...
            <Link to="/doctors" className="dashboardCards">
              ...
              <h4>{doctors === null ? 0 : doctors.length}</h4>
              <p>Total Doctors</p>
            </Link>
            ...
            <Link to="/pharma" className="dashboardCards">
              ...
              <h4>{pharma === null ? 0 : pharma.length}</h4>
              <p>Total Pharmas</p>
            </Link>
            ...
            <Link to="/ambulance" className="dashboardCards">
              ...
              <h4>{ambulance === null ? 0 : ambulance.length}</h4>
              <p>Total Ambulance</p>
            </Link>
