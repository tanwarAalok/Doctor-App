...
import { dashboard } from "../Axios/apis";
...
const ClientDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const monthval = parseInt(monthValue) + 1;
      const date = `01/${monthval < 10 ? `0${monthval}` : `${monthval}`}/${
        yearValue % 2000
        }`;
  ...
  if (dashboardData !== null) {
    data = {
      labels: [...Array(dashboardData?.revArray.length + 1).keys()].slice(1),
      datasets: [
        {
          data: dashboardData?.revArray,
        ...
        <div className="main-div">
          ...
          <div className="card-container">
            <Link to="/patients" className="dashboardCards">
              ...
              <h4>{dashboardData === null ? 0 : dashboardData?.patient}</h4>
              <p>Total Patients</p>
            </Link>
            ...
            <Link to="/doctors" className="dashboardCards">
              ...
              <h4>{dashboardData === null ? 0 : dashboardData?.doctor}</h4>
              <p>Total Doctors</p>
            </Link>
            ...
            <Link to="/pharma" className="dashboardCards">
              ...
              <h4>{dashboardData === null ? 0 : dashboardData?.pharmacy}</h4>
              <p>Total Pharmas</p>
            </Link>
            ...
            <Link to="/ambulance" className="dashboardCards">
              ...
              <h4>{dashboardData === null ? 0 : dashboardData?.ambulance}</h4>
              <p>Total Ambulance</p>
            </Link>
            ...
            <Link to="/revnue" className="dashboardCards">
              ...
              <h4>{dashboardData === null ? 0 : dashboardData?.totalRevenue}</h4>
              <p>Total Revnue</p>
            </Link>
          </div>
